...
/*   Updated: 2025/08/23 18:58:43 by dnahon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	bsp(Point const a, Point const b, Point const c, Point const point)
{
	...
	on_slope = (d1 == 0 && Point::min(a.getX(), b.getX()) <= point.getX()
			&& point.getX() <= Point::max(a.getX(), b.getX())) || (d2 == 0
			&& Point::min(b.getX(), c.getX()) <= point.getX()
			&& point.getX() <= Point::max(b.getX(), c.getX())) || (d3 == 0
			&& Point::min(c.getX(), a.getX()) <= point.getX()
			&& point.getX() <= Point::max(c.getX(), a.getX()));
